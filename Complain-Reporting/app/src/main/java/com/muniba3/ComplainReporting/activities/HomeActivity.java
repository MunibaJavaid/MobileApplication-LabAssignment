...
import com.muniba3.ComplainReporting.sql.SQLiteHelper;
...
public class HomeActivity extends AppCompatActivity {
    ...
    EditText mEdtCategorie, mEdtSeverity, mEdtDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEdtCategorie = findViewById(R.id.edtCategorie);
        mEdtSeverity = findViewById(R.id.edtSeverity);
        ...
        mSQLiteHelper.queryData("CREATE TABLE IF NOT EXISTS RECORD(id INTEGER PRIMARY KEY AUTOINCREMENT, categorie VARCHAR, severity VARCHAR, description VARCHAR, image BLOB)");
