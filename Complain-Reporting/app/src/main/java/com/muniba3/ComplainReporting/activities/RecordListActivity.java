...
public class RecordListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = HomeActivity.mSQLiteHelper.getData("SELECT * FROM RECORD");
        mList.clear();
        while (cursor.moveToNext()){
            ...
            //add to list
            mList.add(new Model(id, categorie, severity, description, image));
        }
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (i == 0){
                            //update
                            Cursor c = HomeActivity.mSQLiteHelper.getData("SELECT id FROM RECORD");
    ...
    private void showDialogDelete(final int idRecord) {
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                try {
                    HomeActivity.mSQLiteHelper.deleteData(idRecord);
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        final EditText edtCategorie = dialog.findViewById(R.id.edtCategorie);
        final EditText edtSeverity = dialog.findViewById(R.id.edtSeverity);
            ...
            public void onClick(View view) {
                try {
                    HomeActivity.mSQLiteHelper.updateData(
                            edtCategorie.getText().toString().trim(),
                            edtSeverity.getText().toString().trim(),
